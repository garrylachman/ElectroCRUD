...
export type LogItemType = LogItemTypeEnum.ERROR | LogItemTypeEnum.INFO | LogItemTypeEnum.SUCCESS | LogItemTypeEnum.WARNING;
type LogItemContent = {
    type: LogItemType;
...
export {};
//# sourceMappingURL=log.define.d.ts.map