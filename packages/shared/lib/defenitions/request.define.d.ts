...
import { ConnectArguments, DeleteDataArguments, InsertDataArguments, ReadDataArguments, ReadWidgetDataArguments, TunnelArguments, UpdateDataArguments } from './server.define';
...
export type RequestType = TablesListRequest | TableInfoRequest | ConnectRequest | HeartBeatRequest | ReadDataRequest | ReadWidgetDataRequest | InsertRequest | DeleteRequest | UpdateRequest | CheckTunnelRequest;
//# sourceMappingURL=request.define.d.ts.map