...
export type QueryAggregate = QueryAggregateEnum.AVG | QueryAggregateEnum.AVG_DISTINCT | QueryAggregateEnum.COUNT | QueryAggregateEnum.COUNT_DISTINCT | QueryAggregateEnum.MAX | QueryAggregateEnum.MIN | QueryAggregateEnum.MIN | QueryAggregateEnum.SUM | QueryAggregateEnum.SUM_DISTINCT;
...
export type ArgumentsType = ConnectArguments | ReadWidgetDataArguments | DeleteDataArguments | InsertDataArguments | UpdateDataArguments | ReadDataArguments | TunnelArguments;
//# sourceMappingURL=server.define.d.ts.map