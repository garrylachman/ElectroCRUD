...
import { ReadDataResult, ReadWidgetDataResult, TableInfoRow } from './server.define';
...
export type ReadDataResponse = SuccessResponse<ReadDataResult<Record<string, any>>>;
export type ReadWidgetDataResponse = SuccessResponse<ReadWidgetDataResult<number>>;
...
export type ResponseTypeSuccess = TablesListResponse | TableInfoResponse | ConnectResponse | HeartBeatResponse | ReadDataResponse | ReadWidgetDataResponse | InsertResponse | DeleteResponse | UpdateResponse | LogResponse;
export type ResponseType = ResponseTypeSuccess | ErrorResponse;
export type ResponseOrError<T> = T & Partial<ErrorResponse>;
//# sourceMappingURL=response.define.d.ts.map