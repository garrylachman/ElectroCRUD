...
export type MenuCell = CustomCell<MenuCellProps> & { readonly: true };
...
const renderer: CustomRenderer<MenuCell> = {
  kind: GridCellKind.Custom,
  isMatch: (c): c is MenuCell => (c.data as any).kind === 'menu-cell',
  needsHover: true,
  ...
  draw: (arguments_, cell) => {
    const { ctx, theme, rect, hoverAmount } = arguments_;
